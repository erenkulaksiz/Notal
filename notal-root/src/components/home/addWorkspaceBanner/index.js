import { AddWorkspaceBannerImage } from "@icons";
...
const AddWorkspaceBanner = () => {
    return <div className="min-h-[400px] absolute left-0 right-0 bottom-0 top-0 pb-48 flex flex-col justify-center items-center">
        <Image src={AddWorkspaceBannerImage} style={{ zIndex: 90 }} width={148} height={148} placeholder="blur" objectFit="contain" priority alt="Add workspace banner" />
