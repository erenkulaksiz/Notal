        ...
        <div className="relative hover:z-40 hover:scale-[101%] hover:-translate-y-0.5 group transition-all ease-in-out">
            <motion.div
                variants={{
                    ...
                    show: { y: 0, opacity: 1, transition: { delay: .03 * (index + 1) } },
                }}
                //exit={{ y: -30, opacity: 0 }}
            ...
            >
                <div className="flex flex-row justify-between group-hover:scale-[97%] transition-all ease-in-out z-20">
                    <div className="flex items-start justify-end text-xl flex-col text-white max-w-[calc(100%-60px)]">
                        ...
                        {!preview ? <Link href="/workspace/[id]" as={`/workspace/${workspace._id || "not-found"}`} passHref>
                    ...
                    {!preview && <div className="flex flex-col justify-end">
                ...
                {(workspace?.thumbnail && workspace?.thumbnail?.type == "image") && (!preview ? <Link href="/workspace/[id]" as={`/workspace/${workspace._id || "not-found"}`} passHref>
