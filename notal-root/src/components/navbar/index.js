                ...
                <summary
                    ...
                    <div className="p-[2px] rounded-full cursor-pointer bg-gradient-to-tr from-blue-700 to-pink-700">
                        <img
                            ...
                            className="w-10 rounded-full border-[2px] dark:border-black border-white"
                        />
                    </div>
                </summary>
                <div className="p-4 absolute top-full rounded-lg right-0 dark:bg-[#110D0A] bg-white shadow-xl w-60 z-50 dark:text-white text-black">
                    <Switch
                        onChange={e => setChecked(e.target.checked)}
                        value={checked}
                        className="mb-2"
                        icon={checked ? <LightIcon size={24} fill="black" style={{ transform: "scale(0.7)" }} /> : <DarkIcon size={24} fill="black" style={{ transform: "scale(0.7)" }} />}
                    />
                    <h2 className="text-current font-bold text-xl">Eren Kulaksiz</h2>
                    <h4 className="text-current text-md">erenkulaksz@gmail.com</h4>
